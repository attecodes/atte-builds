    ...
    <footer className="bg-navy text-stone-300 mt-auto">
      <div className="mx-auto max-w-6xl px-4 pt-12 pb-8 flex flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          <a
            href="https://www.youtube.com/@SDFinish"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="SD Finish on YouTube"
          ...
          >
            ...
            <span className="text-sm">@SDFinish</span>
          </a>
          <a
            href="https://www.instagram.com/sdfinishco"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="SD Finish on Instagram"
            className="flex items-center gap-2 text-stone-400 hover:text-pink-500 transition-colors"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <span className="text-sm">@sdfinishco</span>
          </a>
        </div>
